...
1. Read `docs/context/CDP_START_HERE.md`.
2. Read `docs/context/SESSION-HANDOFF.md`.
3. Read `docs/context/AI-MEMORY-BRIEF.md`.
4. Read `collab/INDEX.md`.
5. Read `collab/COUNCIL_ROLES.md`.
6. Read the active session file, if one exists.
7. Read the relevant RFCs.
8. State what you read and what you could not access.
9. Name the failure mode before proposing a patch.
10. Distinguish canon from collab notes.
11. Preserve dissent and deferred questions.
12. Recommend the narrowest canonical next move.
