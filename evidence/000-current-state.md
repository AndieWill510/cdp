...
| Standing and Recusal (RFC-CDP-033) | Not Implemented (E0) | No evidence currently available. This slice deliberately does not implement Standing -- see Non-Goals in `docs/session-027-identity-and-attestation.md`. RFC-CDP-033 itself was clarified to Draft v0.7 in session 034 (`docs/session-034-rfc-033-standing-recognition-clarification.md`) -- a specification change only, not an evidence change; this row's classification is unaffected. |
