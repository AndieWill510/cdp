...
| Adjudicate (RFC-CDP-044) | Integration Tested (E4) | Route: `POST /decisions/{registry_name}/{decision_id}/challenges/{challenge_id}/adjudications`. DDL: `db/ddl/007-challenge-adjudication.sql`. Tests: `tests/test_challenge_adjudication_service.py`, `tests/test_challenge_adjudication_api.py`, `tests/test_migration_007_challenge_adjudication.py`. Same CI run as above. |
...
`tests/test_execution_record_api.py`, each failing with `404 Not Found` on
