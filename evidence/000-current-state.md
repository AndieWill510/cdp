...
|---|---|---|
| Identify (RFC-CDP-030) | Not Implemented (E0) | No authentication/identity code found under `cdp/`. `README-control-plane-v0.1.md` states the dormant `src/cdp_control_plane` prototype has "No auth." |
| Attest (RFC-CDP-031) | Not Implemented (E0) | No evidence currently available. |
| Standing and Recusal (RFC-CDP-033) | Not Implemented (E0) | No evidence currently available. |
